...
const EventManagerLayout = () => {
  ...
  const navigation = [
    { name: 'Dashboard', href: '/event-manager', icon: HomeIcon, current: location.pathname === '/event-manager' },
    { name: 'Session Review', href: '/event-manager/sessions', icon: DocumentTextIcon, current: location.pathname === '/event-manager/sessions' },
    { name: 'Agenda Builder', href: '/event-manager/agenda', icon: CalendarIcon, current: location.pathname === '/event-manager/agenda' },
    ...
    <div className="flex min-h-0 flex-1 flex-col bg-white border-r border-gray-200">
      ...
      <div className="flex h-16 items-center px-6 border-b border-gray-200">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-lg font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Admin Portal</h1>
